...
@rem ##########################################################################
@rem
@rem  ElisEurekaService startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and ELIS_EUREKA_SERVICE_OPTS to pass JVM options to this script.
set DEFAULT_JVM_OPTS="-Deureka.client.props=elis-eureka-service"
...
@rem Execute ElisEurekaService
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %ELIS_EUREKA_SERVICE_OPTS%  -classpath "%CLASSPATH%" com.netflix.eureka.ElisEurekaService %CMD_LINE_ARGS%
...
:fail
rem Set variable ELIS_EUREKA_SERVICE_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%ELIS_EUREKA_SERVICE_EXIT_CONSOLE%" exit 1
exit /b 1
